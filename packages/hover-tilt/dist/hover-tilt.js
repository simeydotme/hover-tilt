...
function HoverTilt($$anchor, $$props) {
	...
	let opacity = user_derived(() => state.current);
	const rotation = 10;
	...
	template_effect(() => {
		...
		styles = set_style(div, '', styles, {
			...
			'--hover-tilt-scale': scale.current,
			'--hover-tilt-rotation-x': `${rotation * tiltFactor()}deg`,
			'--hover-tilt-rotation-y': `${rotation * (tiltFactorY() ?? tiltFactor())}deg`,
