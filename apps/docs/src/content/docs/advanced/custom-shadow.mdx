...
import {
  simpleShadowSvelte,
  simpleShadowWebComponent,
  neonShadowSvelte,
  neonShadowWebComponent
} from './custom-shadow.strings';
...
Here's a **breakdown of a _simple_ custom shadow**, with each part and how it works.
